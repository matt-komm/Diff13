...
class SamplesPowheg(Module.getClass("Samples")):
    ...
    def getSample(self,name):
        ...
        altDict = {
            ...
            {
                "processes":[
                    "ST_t-channel_top_4f_leptonDecays_13TeV-powheg-pythia8_TuneCUETP8M1_iso"+syst,
                    "ST_t-channel_antitop_4f_leptonDecays_13TeV-powheg-pythia8_TuneCUETP8M1_iso"+syst,
                ],
...
class UtilsPowheg(Module.getClass("Utils")):
    ...
    def getOutputFolder(self):
        return os.path.join(os.getcwd(),"result/Powheg")
