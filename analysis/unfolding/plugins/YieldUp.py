...
class UtilsYieldUp(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsYieldUp.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getOutputFolder(self):
        return os.path.join(os.getcwd(),"result/"+self.getOption("scalefactor")+"YieldUp")
        

class HistogramCreatorYieldUp(Module.getClass("HistogramCreator")):
    def __init__(self,options=[]):
        HistogramCreatorYieldUp.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
