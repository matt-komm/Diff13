...
sampleDict = {
    ...
    "WJets":
    {
        ...
        "weight":"((Generated_1__genweight<0)*(-1)+(Generated_1__genweight>0)*1)*1.8"
    },
...
for category in [
    ...
    for var in [
        ...
        ["ljet_mass","SingleTop_1__LightJet_1__Mass","light jet #eta","","1",50,0.0,50.0],
        ...
        ["cosTheta_tPL","SingleTop_1__cosTheta_tPL","cos#theta_{l,q}^{top}","","1",50,-1,1],
        ["cosTheta_tPB","SingleTop_1__cosTheta_tPB","cos#theta_{l,b}^{top}","","1",50,-1,1],
        ["cosTheta_tPN","SingleTop_1__cosTheta_tPN","cos#theta_{l,#nu}^{top}","","1",50,-1,1],
        
        ["cosTheta_wH","SingleTop_1__cosTheta_wH","cos#theta_{helicity}^{W}","","1",50,-1,1],
        ["cosTheta_wT","SingleTop_1__cosTheta_wT","cos#theta_{transverse}^{W}","","1",50,-1,1],
        ["cosTheta_wN","SingleTop_1__cosTheta_wN","cos#theta_{normal}^{W}","","1",50,-1,1], 
        
                        
    ]:
        
        for qcd in [["qcdnone","1",""],["qcdmtw","(SingleTop_1__mtw_beforePz>50.0)","MTW>50 GeV"]]:
                ...
                for process in sample["processes"]:
                    for f in rootFiles:
                        ...
                        if (tree):
                            ...
                            tree.Project(tempHist.GetName(),variableName,"8.0*mc_weight*"+sample["weight"]+"*"+weight)
            ...
            if unit!="":
                axis=ROOT.TH2F("axis"+str(random.random()),";"+variableTitle+" ("+unit+");events",50,xmin,xmax,50,0,1.1*max(sumHistMC.GetMaximum(),sumHistData.GetMaximum()))
            else:
                axis=ROOT.TH2F("axis"+str(random.random()),";"+variableTitle+";events",50,xmin,xmax,50,0,1.1*max(sumHistMC.GetMaximum(),sumHistData.GetMaximum()))
            ...
            pText=ROOT.TPaveText(0.18,0.94,0.18,0.94,"NDC")
            ...
            pCat=ROOT.TPaveText(0.5,0.94,0.5,0.94,"NDC")
            ...
            pLumi.AddText("8pb#lower[-0.7]{#scale[0.7]{-1}} (13TeV)")
            pLumi.Draw("Same")
