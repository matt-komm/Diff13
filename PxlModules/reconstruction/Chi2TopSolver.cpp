                    ...
                    for (unsigned ieventView=0; ieventView<eventViews.size();++ieventView)
                    {
                        ...
                        if (eventView->getName()==_inputEventViewName)
                        {
                            ...
                            if (eventView->getName()==_inputEventViewName)
                            {
                                ...
                                std::function<double(const double*)> chi2 = [=](const double *xx )
                                {
                                    ...
                                    //chi2+=std::pow((neutrinoPhi-met->getPhi())/0.3,2);
                                    ...
                                    chi2+=std::pow((leptonPhi-lepton->getPhi())/0.2,2);
                                    chi2+=std::pow((leptonEta-lepton->getEta())/0.2,2);
                                    chi2+=std::pow((leptonPt-lepton->getPt())/1,2);
                                    ...
                                    chi2+=fabs(wMass2-80.3*80.3)/1.0;

                                    const double bjetPt = fabs(xx[6]);
                                    const double bjetPhi = xx[7];
                                    const double bjetEta = xx[8];
                                    
                                    //chi2+=pow((bjetPt-bjets[0]->getPt())/5.0,2);
                                    //chi2+=pow((bjetPt-bjets[0]->getPhi())/0.5,2);
                                    //chi2+=pow((bjetPt-bjets[0]->getEta())/1.0,2);
                                    ...
                                    chi2+=fabs(topMass2-173.0*173.0)/9.0;
